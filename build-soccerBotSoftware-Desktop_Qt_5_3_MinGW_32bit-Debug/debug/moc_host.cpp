...
QT_MOC_LITERAL(12, 125, 10)
    ...
    "clientAdded\0sendBroadcast\0sendGameSync\0"
    "readData\0checkValidDgram\0QHostAddress\0"
    "sender\0senderPort"
};
...
static const uint qt_meta_data_Host[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, QMetaType::QByteArray,    3,
    QMetaType::Void,
    QMetaType::Bool, QMetaType::QByteArray, 0x80000000 | 10, QMetaType::UShort,    3,   11,   12,
...
void Host::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->clientAdded(); break;
        case 3: _t->sendBroadcast(); break;
        case 4: _t->sendGameSync((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 5: _t->readData(); break;
        case 6: { bool _r = _t->checkValidDgram((*reinterpret_cast< QByteArray(*)>(_a[1])),(*reinterpret_cast< QHostAddress(*)>(_a[2])),(*reinterpret_cast< quint16(*)>(_a[3])));
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Host::clientAdded)) {
                *result = 2;
            }
        }
    }
