...
#include "../soccerBotSoftware/gamedata.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GameData_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GameData_t qt_meta_stringdata_GameData = {
    {
QT_MOC_LITERAL(0, 0, 8), // "GameData"
QT_MOC_LITERAL(1, 9, 14), // "updateGameData"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "GameData\0updateGameData\0"
};
...
void GameData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateGameData(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject GameData::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameData.data,
      qt_meta_data_GameData,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GameData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameData.stringdata0))
